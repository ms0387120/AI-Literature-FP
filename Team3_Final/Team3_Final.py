...
loc = ['洞房','王國','地窖','農場','市政廳', '水塘', '遊樂園', '圳溝', '池塘', '高塔', '古堡', '噴泉', '山林', '屋頂', '林區', '廚房', '家', '迷宮', '摩天樓', '磚屋', '巖洞', '客廳', '浴缸', '奶奶家', '壩', '六家', '頂層', '座', '山溝', '起居室', '坑', '山巔', '木屋子', '臥室', '修道院', '井里', '花園', '浴室', '摩天大樓', '教堂', '溫莎堡', '莊園', '山腳', '山頂', '佛塔', '聖母院', '庭園', '溪谷', '聖殿', '水池', '主教座堂', '山坡', '竹林', '山崗', '天主教堂', '八仙山', '深潭', '森林', '白金漢宮', '咖啡館', '臥房', '林木', '寺院', '雨林', '王宮', '潭', '塘', '摩天輪', '小河', '斷崖', '電視塔', '宮殿', '溝', '山丘', '庭院', '池', '庴', '稻草屋', '城堡', '大殿', '水潭', '河岸', '夏宮', '儲藏室', '山', '皇宮', '湖畔', '清真寺', '拱門', '原始林', '溪', '森林區', '圓頂', '禮拜堂', '廁所', '大雪山', '河', '崖']
# 老師地點暗示放這

char_except = ['人','丈夫','狼說','好孩子','身邊說','人們心中', '父親','母親','美好願望', '好幾', '個個', '小女兒', '美如天仙','小公主','嚴冬時節', '大雪片', '窗子邊', '針線活兒', '寒風捲著', '捲著雪片', '烏木窗臺', '針口流了', '女兒','三點血滴', '飄進窗子', '鮮紅血滴', '烏木窗臺', '血一樣', '這窗子','他們','你們','我們','弟弟','女水妖','斧子','老太婆','說']
family_member= ['兄嫂','祖母','兄妹','前妻', '大伯','前夫','媽咪','伯伯','後娘','姐姐', '伯父', '兄弟', '繼父', '姊妹', '外公', '叔叔','姐弟', '堂兄弟','老婆','奶媽', '大哥','小妹', '大姊','老爸','舅舅','外婆','爸媽','大姐','公公', '太太','姪女','二哥', '姨丈','姐妹','祖父','爺爺','阿公','岳父','姊姊','孫兒','堂弟', '嬸婆','外祖母','阿姨', '嬸嬸', '三哥','姐夫', '姑姑','哥哥','大弟', '繼母','弟弟','兄長','後母', '老伴', '姨媽','大嫂','外祖父','曾祖父','岳母', '姊弟','妹妹','奶奶','奶奶','爸爸','姊夫']
passerby = ['老國王','驢兒','上帝','樂師','農婦','農夫','羊','白雪公主', '副首相', '愛麗絲', '白熊', '老太太', '青蛙', '馬格麗特', '蝙蝠', '趙自強', '王儲', '天鵝', '巫婆', '丫頭', '李訥', '結拜', '馬伕', '王子', '老奶奶', '松鼠', '牧童', '灰姑娘', '畢蘭德拉', '皇后', '妖精', '安妮', '審議官', '兔子', '狐狸', '魔鏡', '蘇菲亞', '新王', '哈山', '怪物', '安娜', '蚱蜢', '武籐嘉文', '魔女', '寶蓮燈', '西遊記', '嬰', '瑪麗亞', '瑪麗', '山豬', '服侍', '幽魂', '孿生', '星星', '親愛的', '夫家', '美人魚', '小妹妹', '稻草人', '女王', '鸚鵡', '莎拉', '經濟院', '碗公', '憶樺', '蜻蜓', '蟒蛇', '愛神', '獅子王', '飛鼠', '烏龜', '小丑', '雙胞胎', '國王', '艾斯瓦利亞', '鐵扇', '菲立普', '夢見', '胡桃鉗', '戽斗', '威廉', '仙履奇緣', '包杜恩', '外相', '藏相', '查理', '醉俠', '妹子', '捕頭', '女巫', '額賀', '楊光南', '幫主', '袋鼠', '僕人', '刺字', '蘿絲', '丸子', '摩納哥', '薔薇', '角頭', '奇遇記', '暱稱', '崇拜者', '俠盜', '仙女', '烏賊', '飛天', '同居人', '貓頭鷹', '李素華', '阿布杜拉', '烏鴉', '吳火眼', '郭朝明', '女僕', '前首相', '雲雀', '阿拉丁', '金枝玉葉', '皇子', '星願', '次官', '老婆婆', '精靈', '公主', '老大', '史蒂芬妮', '甜甜', '瑪格麗特', '王后', '小矮人', '詩琳通', '救世主', '親生', '白鵝', '親王', '阿嬤', '珍妃', '小弟', '貓咪', '野狼', '駱駝', '花木蘭', '大臣', '獵人', '猴子', '吸血鬼', '貓', '露西', '巴爾札克', '小白', '哈利', '雷尼爾', '賈南德拉', '雙親', '野豬', '王妃', '吳仕傑']
# 老師人物暗示放這
