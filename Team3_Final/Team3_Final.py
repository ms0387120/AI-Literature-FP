...
family_member = ['祖父','祖母','爺爺','奶奶','外公','外婆','爸爸','媽媽','叔叔','舅舅','阿姨','嬸嬸','後母','姊姊','姐姐','繼母','姊妹','大哥', '二哥','小弟', '兒子', '女兒', '夫婦', '母親']
passerby = ['公主','王子','女巫','狐狸','國王','皇后','獵人','王后','小矮人','魔鏡','野狼','妖精','精靈','僕人','灰姑娘','大臣','水妖','男孩','老人', '裁縫', '上帝', '學徒', '師傅', '老太婆', '僕人', '寡婦', '小孩']
# 老師人物暗示放這
